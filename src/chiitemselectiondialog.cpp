...
ChiItemSelectionDialog::ChiItemSelectionDialog(chi::Context& ctx, boost::filesystem::path* toFill, WorkspaceTree::eType type, QWidget* parent) : QDialog{parent}, mToFill{toFill}, mType{type}
{
	...
	connect(buttonBox, &QDialogButtonBox::accepted, this, [this] {
		tryAccept(mTreeView->currentIndex());
	});
...
boost::filesystem::path ChiItemSelectionDialog::getItem(QWidget* parent, chi::Context& ctx, const QString& title, WorkspaceTree::eType type, const boost::filesystem::path& startWithSelection)
{
