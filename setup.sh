...
if [  "$(expr substr $(uname -s) 1 5)" == "Linux" ]; then
	...
	dlAndExtract 'https://github.com/chigraph/chigraph/releases/download/dependencies/kf5-5.32.0-debug-gcc-linux64.tar.xz' "$tpdir/kf5-debug.tar.xz" $tpdir
	dlAndExtract 'https://github.com/chigraph/chigraph/releases/download/dependencies/kf5-5.32.0-release-gcc-linux64.tar.xz' "$tpdir/kf5-release.tar.xz" $tpdir
